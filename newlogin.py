...
#    register_screen = Toplevel(main_screen)
    ...
    register_screen.geometry("2070x1250")
    ...
    Label(register_screen, text="Please enter the username and password", bg="green").pack()
...
def login():
    ...
    login_screen.geometry("2070x1250")
    Label(login_screen, text="Please enter the username and password").pack()
...
def password_not_recognised():
    ...
    password_not_recog_screen.geometry("800x700")
...
def user_not_found():
    ...
    user_not_found_screen.geometry("800x700")
...
def main_account_screen(frmmain):
    ...
    main_screen.geometry("2070x1250")
    main_screen.title("Account Login")
    Label(main_screen,text="Select Your Choice", bg="blue", width="300", height="2", font=("Calibri", 18)).pack()
