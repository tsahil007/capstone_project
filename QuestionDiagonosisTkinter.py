...
class QuestionDigonosis(Frame):
    ...
    def __init__(self,master=None):
        master.title("DocBot - HealthCare Chatbot")
        # root.iconbitmap("")
        master.state("z")
#        master.minsize(700,350)
    ...
    def createWidget(self):
        self.lblQuestion=Label(self,text="Question",width=15,bg="bisque")
        self.lblQuestion.grid(row=0,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Diagnosis",width=15,bg="bisque")
        ...
        self.btnNo=Button(self,text="No",width=12,bg="ORANGE", command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=12,bg="coral", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=12,bg="navy", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=12,bg="aqua", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        super().__init__(master=master)
        master.geometry("2070x1250")
        master.configure(bg='lawngreen')
        master.title("Account Login")
        self.createWidget()
    def createWidget(self):
        
        self.lblMsg=Label(self, text="DocBot - HealthCare Chatbot", bg="orange", width="400", height="2", font=("Calibri", 30))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="1", width="500", command = self.lblLogin_Click,font=("Calibri", 20))
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="1", width="500", command = self.btnRegister_Click,font=("Calibri", 20))
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="slateblue4", width = "350", height = "1", font=("Calibri", 10))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Divyansh Dodan", bg="RoyalBlue1", width = "350", height = "1", font=("Calibri", 10))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Depanshi Tomar", bg="RoyalBlue2", width = "350", height = "1", font=("Calibri", 10))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Sahil Thakur", bg="RoyalBlue1", width = "350", height = "1", font=("Calibri", 10))
        self.lblTeam3.pack()
        self.lblTeam3=Label(self, text="Shivam", bg="RoyalBlue2", width = "350", height = "1", font=("Calibri", 10))
        self.lblTeam3.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter Username and Password",bg="cyan")
        self.lblMsg.pack()
        ...
        self.btnLogin=Button(self, text="Login", width=18, height=2,bg="cyan", command=self.btnLogin_Click)
        self.btnLogin.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter the Username and Password", bg="cyan")
        self.lblMsg.pack()
        ...
        self.btnRegister=Button(self, text="Register", width=15, height=2, bg="cyan", command=self.register_user)
        self.btnRegister.pack()
